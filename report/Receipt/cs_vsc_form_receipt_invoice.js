...
define([
  ...
  function fieldChanged(context) {
    try {
      ...
      if (
        ...
        let scriptId = {
          scriptId: "customscript_sl_vsc_report_receipt_sw",
          deploymentId: "customdeploy_sl_vsc_report_receipt_sw",
        };
  ...
  function printReport(item) {
    try {
      ...
      // customdeploy_sl_vsc_wp_report_receipt
      let scriptId = {
        scriptId: "customscript_sl_vsc_wp_report_receipt",
        deploymentId: "customdeploy_sl_vsc_wp_report_receipt",
      };
      let url = getSuiteletUrl(scriptId, params);
  ...
  function printReportInvoice(item) {
    try {
      let params = {};
      let scriptId = {
        scriptId: "customdeploy_sl_vsc_wp_report_receipt",
        deploymentId: "customdeploy_sl_vsc_wp_report_receipt",
      };
      let url = getSuiteletUrl(scriptId, params);
